...
{
    public class Mob_types : List<Base_type>
    {
        public Mob_types()
        {
            Add(new Base_type { name = "ALL", display_name = "All" });
            Add(new Base_type { name = "CLASS", display_name = "Same" });
            ...
            Add(new Base_type { name = "SPIDER", display_name = "Spider" });
              //  new Mob { name = "spider_jockey", display_name = "Spider Jockey" });
